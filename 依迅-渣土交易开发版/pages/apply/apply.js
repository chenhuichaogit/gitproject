...
//const muckCodeUrl = require('../../utils/config.js').muckSubmitUrl;
...
//获取应用实例
var app = getApp();
var imgs, mobileVal, iphonecodeVal, titleVal, selltypeVal, messageVal, placeVal, eindex, chooseType = 1;
...
Page({
  ...
  onShow:function(){
    ...
    //     address: wx.getStorageSync('$location').address,
    //   });
    // }
  },
 ...
 // 获取渣土交易信息
  getMuckSubmit: function () {
    ...
    //利用封装好的ajax请求数据
    app.getJson(muckSubmitUrl, {Phone: phone, SoilType: eindex, TransType: chooseType, Title: titleVal, Description: messageVal, Address: placeVal, Lng: Lng, Lat: Lat, FileIds: deleImgId,Id:0}, 'post', function (res) {
  ...
  bindKeyInput: function (e) {
    ...
    var name = wx.getStorageSync('$userInfomation').name;
