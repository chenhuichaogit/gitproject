...
Page({
  ...
  getCarSubmit: function () {
    ...
    // var Lng = Location.oLon;
    // var Lat = Location.oLat;
    var Lng = self.data.longitude;
    var Lat = self.data.latitude;
    console.log(deleImgId);
    var phone = wx.getStorageSync('$phone');
    //利用封装好的ajax请求数据
    app.getJson(carSubmitUrl, { Phone: phone,CarType: self.data.jobindex, TransType: chooseType, Title: titleVal, Description: messageVal, Address: placeVal, Lng: Lng, Lat: Lat, FileIds:deleImgId, Id: self.data.id }, 'post', function (res) {
